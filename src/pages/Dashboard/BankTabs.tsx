...
export const BankTabs = ({ financialInstitutions, setCurrentFinancialInstitution }: { financialInstitutions: any[], setCurrentFinancialInstitution: (institution: any) => void }) => {
            ...
            <Stack direction="row" paddingInline={2} spacing={3} alignItems="center">
                {banks.map((bank) =>
                    bank.FinancialInstitutionId === selected.FinancialInstitutionId ? (
                        <Button
                            key={bank}
                            onClick={() => { setSelected(bank), setCurrentFinancialInstitution(bank.FinancialInstitutionId) }}
                            variant="contained"
                            sx={{

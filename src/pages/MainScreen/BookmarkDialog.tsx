...
const BookMarkDialog: React.FC<Props> = ({ close }) => {
    return (
        <Box style={{ position: 'absolute', backgroundColor: 'rgba(0, 0, 0, 0.7)', width: '100%', height: '100%', zIndex: 100, alignItems: 'center', justifyContent: 'center' }}
            ...
            <Box style={{ flexDirection: 'column', alignItems: 'center', alignSelf: 'center', justifyContent: 'center', width: '640px', height: '480px', backgroundColor: 'white', borderRadius: '12px' }}>
                ...
                <UnionText text={'Select a Bank'} />
                <UnionText text={'Scan the QR code'} />
                <UnionText text={'Input your login credentials into the Bank’s App'} />
                <UnionText text={'Select the Account(s)'} />
                <UnionText text={'Confirm'} />
                <UnionText text={'Submit the consented accounts'} />

...
const TopBar: React.FC<IBookmark> = ({ show }) => {
    ...
    return (
        <Box style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', width: '100%' }}
            display={'flex'}
            sx={{
            ...
            <Box style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', alignContent: 'center' }}
                display={'flex'}>
                <Box
                    component="img"
                    loading="lazy"
                ...
                <Box style={{ flexDirection: 'row', display: 'flex', paddingLeft: "18px", paddingRight: "16px", justifyContent: 'space-between', alignContent: 'center', alignItems: 'center', backgroundColor: '#F7F8FA', width: '240px', height: '54px', marginLeft: 6, borderRadius: "16px" }}
                    onClick={() => { }}>
                    <Box
